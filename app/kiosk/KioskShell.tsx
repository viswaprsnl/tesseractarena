...
// Server-rendered QR SVG for the walk-in booking flow is passed down as a
// string prop from the /kiosk server component so this file doesn't need
// to import qrcode. Keeps the client bundle small and lets the SVG be
// cached alongside the page.
interface KioskShellProps {
  walkInBookingUrl: string;
  walkInQrSvg: string;
}
